...
* No red flag:
  ...
  * Answering without a thorough understanding of the requirements. Take time to ask questions to clarify requirements and assumptions, and write them down.

## A 4-step process for effective system design interview

### Step 1 - Understand the problem and establish design scope (3-10 minutes)

* What specific/important features are we going to build?
* How many users does the product have?
* Traffic volume?
* What is the type of data source?
...
Should we include API endpoints and database schema here? This depends on the problem and ask the interviewer.
...
* Had some initial ideas about areas to focus on in the deep dive based on her feedback
